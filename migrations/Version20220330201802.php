 ...
 */
final class Version20220330201802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, categories_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, active TINYINT(1) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, INDEX IDX_CB988C6F67B3B43D (users_id), INDEX IDX_CB988C6FA21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
